...
public/icon/
  16.png / 32.png / 48.png / 128.png / 256.png / 512.png  # Dragon House Hub extension icons
```
...
- Dragon House Hub branding uses the approved source logo exported to `16/32/48/128/256/512`.
